...
## Start with figures from the first draft of the manuscript 
...
## Then produce figures for the second draft of the manuscript

```{r generate_second_figures, quiet = TRUE, warning = FALSE}
source(here("scripts", "04_create_output", "06_create_additional_manuscript_figures.R"))
source(here("scripts", "04_create_output", "07_create_methods_example.R"))
```