...
flowlines %>%
  ...
  scale_y_continuous(breaks = seq(from = 0,
                                  to = sum(flowlines$lengthkm) + 25000,
                                  by = 25000),
                     expand = c(0, 0)) +
...
network_labels <- c("active", "regional reconfigured", "simple reconfigured")
names(network_labels) <- c("in_gaged_network", "in_region_reconfig_network",
...
flowlines %>%
  ...
  scale_x_discrete(labels = c("active gaged network",
                              ...
                              "simple reconfigured network")) +
  scale_y_continuous(breaks = seq(from = 0,
                                  to = sum(flowlines$ref_quality_lengthkm),
                                  by = 5000),
                     expand = c(0, 0)) +
